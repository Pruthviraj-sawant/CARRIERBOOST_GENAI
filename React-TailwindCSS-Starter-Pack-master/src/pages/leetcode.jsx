...
// function LeetCodeProfileFetcher() {
...
//       <h1 className="text-2xl font-bold mb-4 text-center">LeetCode Profile Fetcher</h1>
...
//       {/* Skeleton Loader */}
//       {loading && (
//         <div className="mt-6 p-4 border rounded animate-pulse space-y-4">
//           <div className="h-6 bg-gray-300 rounded w-1/2 mx-auto" />
//           <div className="h-4 bg-gray-300 rounded w-3/4 mx-auto" />
//           <div className="h-4 bg-gray-300 rounded w-2/4 mx-auto" />
//         </div>
//       )}
...
// <p className="text-gray-500">{profile.profile.realName}</p>   
// <p className="text-gray-600">{profile.profile.aboutMe}</p>
// <p className="text-gray-600">{profile.profile.jobTitle}</p>
// <p className="text-gray-500">{profile.profile.countryName}</p>
// <p className="text-gray-500">{profile.profile.company}</p>
// <p className="text-gray-500">{profile.profile.skillTags}</p>
// <p className="text-gray-500">{profile.profile.company}</p>
// {profile.profile.school && <p className="text-gray-400">🎓 {profile.profile.school}</p>}
//           </div>
...
//                   <span key={index} className="bg-indigo-200 px-2 py-1 rounded-full text-sm">
//                     {skill}
//                   </span>
//                 ))}
//               </div>
...
//           {profile.profile.websites.length > 0 && (
//             <div className="mt-4">
//               <h3 className="font-bold mb-2">Websites:</h3>
//               <ul className="list-disc list-inside">
//                 {profile.profile.websites.map((site, index) => (
//                   <li key={index}>
//                     <a href={site} className="text-indigo-600 underline" target="_blank" rel="noopener noreferrer">
//                       {site}
//                     </a>
//                   </li>
//                 ))}
...
//               <p className="text-gray-700">{profile.profile.aboutMe}</p>
//             </div>
//           )}
//         </div>
//       )}
...
// export default LeetCodeProfileFetcher;
